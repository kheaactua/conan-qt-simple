...
class QtConan(ConanFile):
    """
    Qt interface package to use a system installed Qt.  This is used on systems
    where building Qt 5.3.2 is too painful.
    """
    ...
    def package_info(self):
        ...
        if self.options.qt_path and len(str(self.options.qt_path)) and os.path.exists(str(self.options.qt_path)):
            ...
            if tools.os_info.is_linux:
                ...
                guesses = [
                    os.path.join(r'C:\\', 'Qt', f'Qt{self.version}', '{major}.{minor}', f'msvc{year}_64_opengl'),
        ...
        self.cpp_info.libs        = tools.collect_libs(self, folder=self.cpp_info.libdirs[0]) # v1.8.0 makes this arg unnecessary
